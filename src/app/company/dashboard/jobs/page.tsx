  ...
  return (
    <div className="mx-auto max-w-[900px] px-4 py-6 md:px-6">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[#0F172A]">Job Vacancies</h1>
          <p className="text-sm text-slate-500">Manage your open positions</p>
        </div>
        <Link
          ...
          >
            <div>
              ...
              <p className="text-xs text-slate-500">
                ...
                {job.requireVideoPitch && " · 🎬 Video required"}
              </p>
            </div>
